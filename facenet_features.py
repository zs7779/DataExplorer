...
def facenet_h5_to_tsv(feature_file):
    with h5py.File(feature_file, 'r') as feature_h5:
        ...
        labels = feature_h5['pains'][::100].round()
        subjects = feature_h5['subjects'][::100]
        np.savetxt('labels.tsv', labels, fmt='%.4f', delimiter='\t', newline='\n')
...
feature_file = 'C:/Users/zhaosh/pain/artifacts/facenet_features/facenet_features_2019-05-28-13-12-40.hdf5'
